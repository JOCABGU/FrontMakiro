        ...
        <FormCard title="Cabecera" description="Datos generales de la orden.">
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <Field label="Observacion">
              <textarea className="input-base h-24 resize-none" value={observacion} onChange={(event) => setObservacion(event.target.value)} />
            </Field>
          </div>
        </FormCard>
          ...
          <div className="grid gap-4 xl:grid-cols-[18rem_1fr]">
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                <Button className="w-full sm:w-auto" type="button" onClick={addMaterial}>
                  Agregar
                </Button>
